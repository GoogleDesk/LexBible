...
const sS = {
  ...
  logoText:{ fontFamily:'"Lora", "Lora", Georgia, serif', fontSize:21, fontWeight:700, color:'#1A1714', letterSpacing:'-0.3px' },
  logoGold:{ color:'#2A6049' },
  logoSub: { fontSize:10, color:'rgba(26,23,20,0.55)', marginTop:3, letterSpacing:'0.8px', textTransform:'uppercase', fontWeight:500 },
  ...
  itemMeta:  { display:'flex', gap:8, marginTop:2, fontSize:11, color:'rgba(26,23,20,0.75)', fontWeight:500 },
